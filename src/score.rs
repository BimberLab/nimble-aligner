...
pub fn score<I, R>(sequences: I, reverse_sequences: Option<I>,
  ...
  library: R, align_config: align::AlignFilterConfig) //-> Vec<(String, f32)>
  where 
  ...
  let results = filter::report::collapse_results_by_column(library, reference_scores.iter(), group_column);
